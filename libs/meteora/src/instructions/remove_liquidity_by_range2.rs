...
impl RemoveLiquidityByRange2 {
  pub fn instruction(&self, args: RemoveLiquidityByRange2InstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: RemoveLiquidityByRange2InstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let accounts = RemoveLiquidityByRange2 {
          ...
          let args = RemoveLiquidityByRange2InstructionArgs {
                                                              from_bin_id: self.from_bin_id.clone().expect("from_bin_id is not set"),
                                                                  ...
                                                                  bps_to_remove: self.bps_to_remove.clone().expect("bps_to_remove is not set"),
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = RemoveLiquidityByRange2InstructionArgs {
                                                              from_bin_id: self.instruction.from_bin_id.clone().expect("from_bin_id is not set"),
                                                                  to_bin_id: self.instruction.to_bin_id.clone().expect("to_bin_id is not set"),
                                                                  bps_to_remove: self.instruction.bps_to_remove.clone().expect("bps_to_remove is not set"),
