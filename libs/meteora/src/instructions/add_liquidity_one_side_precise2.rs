...
impl AddLiquidityOneSidePrecise2 {
  pub fn instruction(&self, args: AddLiquidityOneSidePrecise2InstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: AddLiquidityOneSidePrecise2InstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let accounts = AddLiquidityOneSidePrecise2 {
          ...
          let args = AddLiquidityOneSidePrecise2InstructionArgs {
                                                              bins: self.bins.clone().expect("bins is not set"),
                                                                  decompress_multiplier: self.decompress_multiplier.clone().expect("decompress_multiplier is not set"),
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = AddLiquidityOneSidePrecise2InstructionArgs {
                                                              bins: self.instruction.bins.clone().expect("bins is not set"),
                                                                  decompress_multiplier: self.instruction.decompress_multiplier.clone().expect("decompress_multiplier is not set"),
