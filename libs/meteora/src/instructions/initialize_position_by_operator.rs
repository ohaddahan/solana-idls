...
impl InitializePositionByOperator {
  pub fn instruction(&self, args: InitializePositionByOperatorInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: InitializePositionByOperatorInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let accounts = InitializePositionByOperator {
          ...
          let args = InitializePositionByOperatorInstructionArgs {
                                                              lower_bin_id: self.lower_bin_id.clone().expect("lower_bin_id is not set"),
                                                                  ...
                                                                  lock_release_point: self.lock_release_point.clone().expect("lock_release_point is not set"),
                                    };
...
#[inline(always)]
    pub fn operator(&mut self, operator: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn operator_token_x(&mut self, operator_token_x: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.operator_token_x = Some(operator_token_x);
                    self
    }
      #[inline(always)]
    pub fn owner_token_x(&mut self, owner_token_x: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = InitializePositionByOperatorInstructionArgs {
                                                              lower_bin_id: self.instruction.lower_bin_id.clone().expect("lower_bin_id is not set"),
                                                                  width: self.instruction.width.clone().expect("width is not set"),
                                                                  fee_owner: self.instruction.fee_owner.clone().expect("fee_owner is not set"),
                                                                  lock_release_point: self.instruction.lock_release_point.clone().expect("lock_release_point is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          operator_token_x: self.instruction.operator_token_x.expect("operator_token_x is not set"),
                  
          owner_token_x: self.instruction.owner_token_x.expect("owner_token_x is not set"),
