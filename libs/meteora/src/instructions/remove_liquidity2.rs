...
impl RemoveLiquidity2 {
  pub fn instruction(&self, args: RemoveLiquidity2InstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: RemoveLiquidity2InstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
#[inline(always)]
    ...
    pub fn program(&mut self, program: solana_pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn bin_liquidity_removal(&mut self, bin_liquidity_removal: Vec<BinLiquidityReduction>) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = RemoveLiquidity2 {
          ...
          let args = RemoveLiquidity2InstructionArgs {
                                                              bin_liquidity_removal: self.bin_liquidity_removal.clone().expect("bin_liquidity_removal is not set"),
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = RemoveLiquidity2InstructionArgs {
                                                              bin_liquidity_removal: self.instruction.bin_liquidity_removal.clone().expect("bin_liquidity_removal is not set"),
