...
impl SwapWithPriceImpact {
  pub fn instruction(&self, args: SwapWithPriceImpactInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SwapWithPriceImpactInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let accounts = SwapWithPriceImpact {
          ...
          let args = SwapWithPriceImpactInstructionArgs {
                                                              amount_in: self.amount_in.clone().expect("amount_in is not set"),
                                                                  ...
                                                                  max_price_impact_bps: self.max_price_impact_bps.clone().expect("max_price_impact_bps is not set"),
                                    };
...
#[inline(always)]
    ...
    pub fn reserve_y(&mut self, reserve_y: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn user_token_in(&mut self, user_token_in: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.user_token_in = Some(user_token_in);
                    self
    }
      #[inline(always)]
    pub fn user_token_out(&mut self, user_token_out: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn oracle(&mut self, oracle: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// `[optional account]`
#[inline(always)]
    pub fn host_fee_in(&mut self, host_fee_in: Option<&'b solana_account_info::AccountInfo<'a>>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = SwapWithPriceImpactInstructionArgs {
                                                              amount_in: self.instruction.amount_in.clone().expect("amount_in is not set"),
                                                                  ...
                                                                  max_price_impact_bps: self.instruction.max_price_impact_bps.clone().expect("max_price_impact_bps is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          user_token_in: self.instruction.user_token_in.expect("user_token_in is not set"),
                  
          user_token_out: self.instruction.user_token_out.expect("user_token_out is not set"),
