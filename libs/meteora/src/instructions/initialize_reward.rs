...
impl InitializeRewardBuilder {
  pub fn new() -> Self {
    ...
    pub fn reward_mint(&mut self, reward_mint: solana_pubkey::Pubkey) -> &mut Self {
            ...
            /// `[optional account]`
#[inline(always)]
    pub fn token_badge(&mut self, token_badge: Option<solana_pubkey::Pubkey>) -> &mut Self {
    ...
    let accounts = InitializeReward {
          ...
          let args = InitializeRewardInstructionArgs {
                                                              reward_index: self.reward_index.clone().expect("reward_index is not set"),
                                                                  reward_duration: self.reward_duration.clone().expect("reward_duration is not set"),
...
impl<'a, 'b> InitializeRewardCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn reward_mint(&mut self, reward_mint: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// `[optional account]`
#[inline(always)]
    pub fn token_badge(&mut self, token_badge: Option<&'b solana_account_info::AccountInfo<'a>>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = InitializeRewardInstructionArgs {
                                                              reward_index: self.instruction.reward_index.clone().expect("reward_index is not set"),
                                                                  reward_duration: self.instruction.reward_duration.clone().expect("reward_duration is not set"),
