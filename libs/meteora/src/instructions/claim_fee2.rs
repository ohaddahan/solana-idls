...
impl ClaimFee2 {
  ...
  pub fn instruction_with_remaining_accounts(&self, args: ClaimFee2InstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
impl<'a, 'b> ClaimFee2CpiBuilder<'a, 'b> {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = ClaimFee2InstructionArgs {
                                                              min_bin_id: self.instruction.min_bin_id.clone().expect("min_bin_id is not set"),
                                                                  max_bin_id: self.instruction.max_bin_id.clone().expect("max_bin_id is not set"),
