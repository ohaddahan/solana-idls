...
impl FundReward {
  ...
  pub fn instruction_with_remaining_accounts(&self, args: FundRewardInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
pub struct FundRewardBuilder {
            lb_pair: Option<solana_pubkey::Pubkey>,
                ...
                bin_array: Option<solana_pubkey::Pubkey>,
...
impl FundRewardBuilder {
  pub fn new() -> Self {
    ...
    pub fn reward_mint(&mut self, reward_mint: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn funder_token_account(&mut self, funder_token_account: solana_pubkey::Pubkey) -> &mut Self {
    ...
    pub fn funder(&mut self, funder: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn bin_array(&mut self, bin_array: solana_pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = FundReward {
                              lb_pair: self.lb_pair.expect("lb_pair is not set"),
                                        ...
                                        funder_token_account: self.funder_token_account.expect("funder_token_account is not set"),
          ...
          let args = FundRewardInstructionArgs {
                                                              reward_index: self.reward_index.clone().expect("reward_index is not set"),
                                                                  ...
                                                                  carry_forward: self.carry_forward.clone().expect("carry_forward is not set"),
...
impl<'a, 'b> FundRewardCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn reward_mint(&mut self, reward_mint: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn funder_token_account(&mut self, funder_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = FundRewardInstructionArgs {
                                                              reward_index: self.instruction.reward_index.clone().expect("reward_index is not set"),
                                                                  ...
                                                                  carry_forward: self.instruction.carry_forward.clone().expect("carry_forward is not set"),
        ...
        __program: self.instruction.__program,
          ...
          funder_token_account: self.instruction.funder_token_account.expect("funder_token_account is not set"),
