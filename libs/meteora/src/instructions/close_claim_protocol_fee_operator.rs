...
impl CloseClaimProtocolFeeOperatorBuilder {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = CloseClaimProtocolFeeOperator {
                              claim_fee_operator: self.claim_fee_operator.expect("claim_fee_operator is not set"),
...
impl<'a, 'b> CloseClaimProtocolFeeOperatorCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    Self { instruction }
      ...
      #[inline(always)]
    pub fn claim_fee_operator(&mut self, claim_fee_operator: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          claim_fee_operator: self.instruction.claim_fee_operator.expect("claim_fee_operator is not set"),
