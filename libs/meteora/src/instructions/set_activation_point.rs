...
impl SetActivationPoint {
  pub fn instruction(&self, args: SetActivationPointInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SetActivationPointInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = SetActivationPoint {
          ...
          let args = SetActivationPointInstructionArgs {
                                                              activation_point: self.activation_point.clone().expect("activation_point is not set"),
                                    };
...
impl<'a, 'b> SetActivationPointCpiBuilder<'a, 'b> {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = SetActivationPointInstructionArgs {
                                                              activation_point: self.instruction.activation_point.clone().expect("activation_point is not set"),
                                    };
