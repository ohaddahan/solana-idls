...
impl SetPreActivationDuration {
  pub fn instruction(&self, args: SetPreActivationDurationInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SetPreActivationDurationInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = SetPreActivationDuration {
          ...
          let args = SetPreActivationDurationInstructionArgs {
                                                              pre_activation_duration: self.pre_activation_duration.clone().expect("pre_activation_duration is not set"),
                                    };
...
impl<'a, 'b> SetPreActivationDurationCpiBuilder<'a, 'b> {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = SetPreActivationDurationInstructionArgs {
                                                              pre_activation_duration: self.instruction.pre_activation_duration.clone().expect("pre_activation_duration is not set"),
                                    };
