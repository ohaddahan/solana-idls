...
impl ClaimReward {
  ...
  pub fn instruction_with_remaining_accounts(&self, args: ClaimRewardInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
