...
impl SetPreActivationSwapAddress {
  pub fn instruction(&self, args: SetPreActivationSwapAddressInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SetPreActivationSwapAddressInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
impl SetPreActivationSwapAddressBuilder {
  pub fn new() -> Self {
    ...
    pub fn creator(&mut self, creator: solana_pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn pre_activation_swap_address(&mut self, pre_activation_swap_address: Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = SetPreActivationSwapAddress {
          ...
          let args = SetPreActivationSwapAddressInstructionArgs {
                                                              pre_activation_swap_address: self.pre_activation_swap_address.clone().expect("pre_activation_swap_address is not set"),
                                    };
...
impl<'a, 'b> SetPreActivationSwapAddressCpiBuilder<'a, 'b> {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = SetPreActivationSwapAddressInstructionArgs {
                                                              pre_activation_swap_address: self.instruction.pre_activation_swap_address.clone().expect("pre_activation_swap_address is not set"),
                                    };
