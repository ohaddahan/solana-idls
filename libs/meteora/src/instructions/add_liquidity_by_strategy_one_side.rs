...
impl AddLiquidityByStrategyOneSide {
  pub fn instruction(&self, args: AddLiquidityByStrategyOneSideInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: AddLiquidityByStrategyOneSideInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let accounts = AddLiquidityByStrategyOneSide {
          ...
          let args = AddLiquidityByStrategyOneSideInstructionArgs {
                                                              amount: self.amount.clone().expect("amount is not set"),
                                                                  ...
                                                                  strategy_parameters: self.strategy_parameters.clone().expect("strategy_parameters is not set"),
                                    };
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = AddLiquidityByStrategyOneSideInstructionArgs {
                                                              amount: self.instruction.amount.clone().expect("amount is not set"),
                                                                  ...
                                                                  strategy_parameters: self.instruction.strategy_parameters.clone().expect("strategy_parameters is not set"),
                                    };
