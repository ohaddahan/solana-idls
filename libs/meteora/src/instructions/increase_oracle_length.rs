...
impl IncreaseOracleLength {
  pub fn instruction(&self, args: IncreaseOracleLengthInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: IncreaseOracleLengthInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = IncreaseOracleLength {
          ...
          let args = IncreaseOracleLengthInstructionArgs {
                                                              length_to_add: self.length_to_add.clone().expect("length_to_add is not set"),
                                    };
...
impl<'a, 'b> IncreaseOracleLengthCpiBuilder<'a, 'b> {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = IncreaseOracleLengthInstructionArgs {
                                                              length_to_add: self.instruction.length_to_add.clone().expect("length_to_add is not set"),
                                    };
