...
impl InitializePermissionLbPair {
  pub fn instruction(&self, args: InitializePermissionLbPairInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: InitializePermissionLbPairInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
impl InitializePermissionLbPairBuilder {
  pub fn new() -> Self {
    ...
    pub fn lb_pair(&mut self, lb_pair: solana_pubkey::Pubkey) -> &mut Self {
            ...
            /// `[optional account]`
#[inline(always)]
    pub fn bin_array_bitmap_extension(&mut self, bin_array_bitmap_extension: Option<solana_pubkey::Pubkey>) -> &mut Self {
    ...
    let accounts = InitializePermissionLbPair {
          ...
          let args = InitializePermissionLbPairInstructionArgs {
                                                              active_id: self.active_id.clone().expect("active_id is not set"),
                                                                  ...
                                                                  base_fee_power_factor: self.base_fee_power_factor.clone().expect("base_fee_power_factor is not set"),
                                                                  activation_type: self.activation_type.clone().expect("activation_type is not set"),
                                                                  protocol_share: self.protocol_share.clone().expect("protocol_share is not set"),
                                    };
...
impl<'a, 'b> InitializePermissionLbPairCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn lb_pair(&mut self, lb_pair: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// `[optional account]`
#[inline(always)]
    pub fn bin_array_bitmap_extension(&mut self, bin_array_bitmap_extension: Option<&'b solana_account_info::AccountInfo<'a>>) -> &mut Self {
                        self.instruction.bin_array_bitmap_extension = bin_array_bitmap_extension;
                    self
    }
      #[inline(always)]
    pub fn token_mint_x(&mut self, token_mint_x: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.token_mint_x = Some(token_mint_x);
                    self
    }
      #[inline(always)]
    pub fn token_mint_y(&mut self, token_mint_y: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn admin(&mut self, admin: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// `[optional account]`
#[inline(always)]
    pub fn token_badge_x(&mut self, token_badge_x: Option<&'b solana_account_info::AccountInfo<'a>>) -> &mut Self {
                        self.instruction.token_badge_x = token_badge_x;
                    self
    }
      /// `[optional account]`
#[inline(always)]
    pub fn token_badge_y(&mut self, token_badge_y: Option<&'b solana_account_info::AccountInfo<'a>>) -> &mut Self {
                        self.instruction.token_badge_y = token_badge_y;
                    self
    }
      #[inline(always)]
    pub fn token_program_x(&mut self, token_program_x: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.token_program_x = Some(token_program_x);
                    self
    }
      #[inline(always)]
    pub fn token_program_y(&mut self, token_program_y: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = InitializePermissionLbPairInstructionArgs {
                                                              active_id: self.instruction.active_id.clone().expect("active_id is not set"),
                                                                  bin_step: self.instruction.bin_step.clone().expect("bin_step is not set"),
                                                                  base_factor: self.instruction.base_factor.clone().expect("base_factor is not set"),
                                                                  base_fee_power_factor: self.instruction.base_fee_power_factor.clone().expect("base_fee_power_factor is not set"),
                                                                  activation_type: self.instruction.activation_type.clone().expect("activation_type is not set"),
                                                                  protocol_share: self.instruction.protocol_share.clone().expect("protocol_share is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          token_mint_x: self.instruction.token_mint_x.expect("token_mint_x is not set"),
                  
          token_mint_y: self.instruction.token_mint_y.expect("token_mint_y is not set"),
          ...
          token_program_x: self.instruction.token_program_x.expect("token_program_x is not set"),
                  
          token_program_y: self.instruction.token_program_y.expect("token_program_y is not set"),
