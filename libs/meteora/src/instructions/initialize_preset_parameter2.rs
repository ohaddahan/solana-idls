...
impl InitializePresetParameter2 {
  pub fn instruction(&self, args: InitializePresetParameter2InstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: InitializePresetParameter2InstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let accounts = InitializePresetParameter2 {
          ...
          let args = InitializePresetParameter2InstructionArgs {
                                                              index: self.index.clone().expect("index is not set"),
                                                                  ...
                                                                  variable_fee_control: self.variable_fee_control.clone().expect("variable_fee_control is not set"),
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = InitializePresetParameter2InstructionArgs {
                                                              index: self.instruction.index.clone().expect("index is not set"),
                                                                  ...
                                                                  variable_fee_control: self.instruction.variable_fee_control.clone().expect("variable_fee_control is not set"),
