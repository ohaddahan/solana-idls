...
impl AddLiquidityByWeight {
  pub fn instruction(&self, args: AddLiquidityByWeightInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: AddLiquidityByWeightInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    pub fn program(&mut self, program: solana_pubkey::Pubkey) -> &mut Self {
      ...
      pub fn max_active_bin_slippage(&mut self, max_active_bin_slippage: i32) -> &mut Self {
        ...
        self
                ...
                #[inline(always)]
      pub fn bin_liquidity_dist(&mut self, bin_liquidity_dist: Vec<BinLiquidityDistributionByWeight>) -> &mut Self {
    ...
    let accounts = AddLiquidityByWeight {
          ...
          let args = AddLiquidityByWeightInstructionArgs {
                                                              amount_x: self.amount_x.clone().expect("amount_x is not set"),
                                                                  ...
                                                                  max_active_bin_slippage: self.max_active_bin_slippage.clone().expect("max_active_bin_slippage is not set"),
                                                                  bin_liquidity_dist: self.bin_liquidity_dist.clone().expect("bin_liquidity_dist is not set"),
                                    };
...
#[inline(always)]
    ...
    pub fn sender(&mut self, sender: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn token_x_program(&mut self, token_x_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.token_x_program = Some(token_x_program);
                    self
    }
      #[inline(always)]
    pub fn token_y_program(&mut self, token_y_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = AddLiquidityByWeightInstructionArgs {
                                                              amount_x: self.instruction.amount_x.clone().expect("amount_x is not set"),
                                                                  amount_y: self.instruction.amount_y.clone().expect("amount_y is not set"),
                                                                  active_id: self.instruction.active_id.clone().expect("active_id is not set"),
                                                                  max_active_bin_slippage: self.instruction.max_active_bin_slippage.clone().expect("max_active_bin_slippage is not set"),
                                                                  bin_liquidity_dist: self.instruction.bin_liquidity_dist.clone().expect("bin_liquidity_dist is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          token_x_program: self.instruction.token_x_program.expect("token_x_program is not set"),
                  
          token_y_program: self.instruction.token_y_program.expect("token_y_program is not set"),
