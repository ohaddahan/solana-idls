...
impl AddLiquidityOneSide {
  pub fn instruction(&self, args: AddLiquidityOneSideInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: AddLiquidityOneSideInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
#[inline(always)]
    pub fn bin_array_bitmap_extension(&mut self, bin_array_bitmap_extension: Option<&'b solana_account_info::AccountInfo<'a>>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn user_token(&mut self, user_token: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
