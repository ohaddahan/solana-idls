...
impl InitializeCustomizablePermissionlessLbPair2 {
  pub fn instruction(&self, args: InitializeCustomizablePermissionlessLbPair2InstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: InitializeCustomizablePermissionlessLbPair2InstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&InitializeCustomizablePermissionlessLbPair2InstructionData::new()).unwrap();
...
impl<'a, 'b> InitializeCustomizablePermissionlessLbPair2CpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(InitializeCustomizablePermissionlessLbPair2CpiBuilderInstruction {
      __program: program,
              lb_pair: None,
