...
impl InitializeCustomizablePermissionlessLbPair {
  pub fn instruction(&self, args: InitializeCustomizablePermissionlessLbPairInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: InitializeCustomizablePermissionlessLbPairInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&InitializeCustomizablePermissionlessLbPairInstructionData::new()).unwrap();
...
impl<'a, 'b> InitializeCustomizablePermissionlessLbPairCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(InitializeCustomizablePermissionlessLbPairCpiBuilderInstruction {
      __program: program,
              lb_pair: None,
