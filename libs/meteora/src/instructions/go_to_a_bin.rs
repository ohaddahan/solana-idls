...
impl GoToABin {
  ...
  pub fn instruction_with_remaining_accounts(&self, args: GoToABinInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
#[inline(always)]
    pub fn bin_array_bitmap_extension(&mut self, bin_array_bitmap_extension: Option<&'b solana_account_info::AccountInfo<'a>>) -> &mut Self {
      ...
      /// `[optional account]`
#[inline(always)]
    pub fn from_bin_array(&mut self, from_bin_array: Option<&'b solana_account_info::AccountInfo<'a>>) -> &mut Self {
                        self.instruction.from_bin_array = from_bin_array;
                    self
    }
      /// `[optional account]`
#[inline(always)]
    pub fn to_bin_array(&mut self, to_bin_array: Option<&'b solana_account_info::AccountInfo<'a>>) -> &mut Self {
