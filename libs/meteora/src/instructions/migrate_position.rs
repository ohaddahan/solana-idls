...
impl<'a, 'b> MigratePositionCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    Self { instruction }
      ...
      #[inline(always)]
    pub fn position_v2(&mut self, position_v2: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.position_v2 = Some(position_v2);
                    self
    }
      #[inline(always)]
    pub fn position_v1(&mut self, position_v1: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn system_program(&mut self, system_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn rent_receiver(&mut self, rent_receiver: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          position_v2: self.instruction.position_v2.expect("position_v2 is not set"),
                  
          position_v1: self.instruction.position_v1.expect("position_v1 is not set"),
