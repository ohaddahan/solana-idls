...
impl AddLiquidityByStrategy2 {
  pub fn instruction(&self, args: AddLiquidityByStrategy2InstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: AddLiquidityByStrategy2InstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
#[inline(always)]
    ...
    pub fn program(&mut self, program: solana_pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn liquidity_parameter(&mut self, liquidity_parameter: LiquidityParameterByStrategy) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = AddLiquidityByStrategy2 {
          ...
          let args = AddLiquidityByStrategy2InstructionArgs {
                                                              liquidity_parameter: self.liquidity_parameter.clone().expect("liquidity_parameter is not set"),
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = AddLiquidityByStrategy2InstructionArgs {
                                                              liquidity_parameter: self.instruction.liquidity_parameter.clone().expect("liquidity_parameter is not set"),
