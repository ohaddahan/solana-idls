...
impl SwapExactOut2 {
  pub fn instruction(&self, args: SwapExactOut2InstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SwapExactOut2InstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = SwapExactOut2 {
          ...
          let args = SwapExactOut2InstructionArgs {
                                                              max_in_amount: self.max_in_amount.clone().expect("max_in_amount is not set"),
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = SwapExactOut2InstructionArgs {
                                                              max_in_amount: self.instruction.max_in_amount.clone().expect("max_in_amount is not set"),
