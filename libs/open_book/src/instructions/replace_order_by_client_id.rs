...
/// Accounts.
#[derive(Debug)]
pub struct ReplaceOrderByClientId {
    /// the market
...
impl ReplaceOrderByClientId {
    pub fn instruction(
        &self,
        args: ReplaceOrderByClientIdInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&ReplaceOrderByClientIdInstructionData::new()).unwrap();
...
pub struct ReplaceOrderByClientIdInstructionData {
    discriminator: [u8; 8],
}

impl ReplaceOrderByClientIdInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [135, 192, 133, 218, 44, 228, 231, 12],
        }
    }
}

impl Default for ReplaceOrderByClientIdInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ReplaceOrderByClientIdInstructionArgs {
    pub args: NewOrderInstructionV3,
}

/// Instruction builder for `ReplaceOrderByClientId`.
///
/// ### Accounts:
///
///   0. `[writable]` market
...
pub struct ReplaceOrderByClientIdBuilder {
...
impl ReplaceOrderByClientIdBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// the market
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = ReplaceOrderByClientId {
        ...
        let args = ReplaceOrderByClientIdInstructionArgs {
...
/// `replace_order_by_client_id` CPI accounts.
pub struct ReplaceOrderByClientIdCpiAccounts<'a, 'b> {
    /// the market
...
/// `replace_order_by_client_id` CPI instruction.
pub struct ReplaceOrderByClientIdCpi<'a, 'b> {
    ...
    pub __args: ReplaceOrderByClientIdInstructionArgs,
}

impl<'a, 'b> ReplaceOrderByClientIdCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: ReplaceOrderByClientIdCpiAccounts<'a, 'b>,
        args: ReplaceOrderByClientIdInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ReplaceOrderByClientId` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` market
...
///   12. `[]` fee_discounts
#[derive(Clone, Debug)]
pub struct ReplaceOrderByClientIdCpiBuilder<'a, 'b> {
    instruction: Box<ReplaceOrderByClientIdCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ReplaceOrderByClientIdCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ReplaceOrderByClientIdCpiBuilderInstruction {
            __program: program,
            market: None,
            open_orders: None,
            request_queue: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = ReplaceOrderByClientIdCpi {
...
#[derive(Clone, Debug)]
struct ReplaceOrderByClientIdCpiBuilderInstruction<'a, 'b> {
