...
/// Accounts.
#[derive(Debug)]
pub struct ReplaceOrdersByClientIds {
    /// the market
...
impl ReplaceOrdersByClientIds {
    pub fn instruction(
        &self,
        args: ReplaceOrdersByClientIdsInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&ReplaceOrdersByClientIdsInstructionData::new()).unwrap();
...
pub struct ReplaceOrdersByClientIdsInstructionData {
    discriminator: [u8; 8],
}

impl ReplaceOrdersByClientIdsInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [206, 207, 54, 236, 89, 129, 143, 211],
        }
    }
}

impl Default for ReplaceOrdersByClientIdsInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ReplaceOrdersByClientIdsInstructionArgs {
    pub args: Vec<NewOrderInstructionV3>,
}

/// Instruction builder for `ReplaceOrdersByClientIds`.
///
/// ### Accounts:
///
///   0. `[writable]` market
...
pub struct ReplaceOrdersByClientIdsBuilder {
    ...
    args: Option<Vec<NewOrderInstructionV3>>,
    __remaining_accounts: Vec<solana_instruction::AccountMeta>,
}

impl ReplaceOrdersByClientIdsBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// the market
    ...
    #[inline(always)]
    pub fn args(&mut self, args: Vec<NewOrderInstructionV3>) -> &mut Self {
        self.args = Some(args);
        self
    }
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = ReplaceOrdersByClientIds {
        ...
        let args = ReplaceOrdersByClientIdsInstructionArgs {
...
/// `replace_orders_by_client_ids` CPI accounts.
pub struct ReplaceOrdersByClientIdsCpiAccounts<'a, 'b> {
    /// the market
...
/// `replace_orders_by_client_ids` CPI instruction.
pub struct ReplaceOrdersByClientIdsCpi<'a, 'b> {
    ...
    pub __args: ReplaceOrdersByClientIdsInstructionArgs,
}

impl<'a, 'b> ReplaceOrdersByClientIdsCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: ReplaceOrdersByClientIdsCpiAccounts<'a, 'b>,
        args: ReplaceOrdersByClientIdsInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ReplaceOrdersByClientIds` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` market
...
///   12. `[]` fee_discounts
#[derive(Clone, Debug)]
pub struct ReplaceOrdersByClientIdsCpiBuilder<'a, 'b> {
    instruction: Box<ReplaceOrdersByClientIdsCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ReplaceOrdersByClientIdsCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ReplaceOrdersByClientIdsCpiBuilderInstruction {
            __program: program,
            market: None,
            open_orders: None,
            request_queue: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = ReplaceOrdersByClientIdsCpi {
...
#[derive(Clone, Debug)]
struct ReplaceOrdersByClientIdsCpiBuilderInstruction<'a, 'b> {
