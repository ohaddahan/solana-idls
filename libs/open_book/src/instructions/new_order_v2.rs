...
impl NewOrderV2 {
    pub fn instruction(&self, args: NewOrderV2InstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        &self,
        args: NewOrderV2InstructionArgs,
        ...
        let mut data = borsh::to_vec(&NewOrderV2InstructionData::new()).unwrap();
...
pub struct NewOrderV2InstructionData {
    discriminator: [u8; 8],
}

impl NewOrderV2InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [113, 151, 157, 25, 61, 181, 5, 246],
        }
    }
}

impl Default for NewOrderV2InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct NewOrderV2InstructionArgs {
    pub side: Side,
    pub limit_price: u64,
    pub max_qty: u64,
...
/// Instruction builder for `NewOrderV2`.
///
/// ### Accounts:
///
///   0. `[writable]` market
...
impl NewOrderV2Builder {
    ...
    #[inline(always)]
    pub fn self_trade_behavior(&mut self, self_trade_behavior: SelfTradeBehavior) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = NewOrderV2InstructionArgs {
            ...
            self_trade_behavior: self
                .self_trade_behavior
                .clone()
                .expect("self_trade_behavior is not set"),
        };
...
/// `new_order_v2` CPI accounts.
pub struct NewOrderV2CpiAccounts<'a, 'b> {
    /// the market
...
/// `new_order_v2` CPI instruction.
pub struct NewOrderV2Cpi<'a, 'b> {
    ...
    pub __args: NewOrderV2InstructionArgs,
}

impl<'a, 'b> NewOrderV2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: NewOrderV2CpiAccounts<'a, 'b>,
        args: NewOrderV2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `NewOrderV2` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` market
...
///   9. `[optional]` fee_discounts
#[derive(Clone, Debug)]
pub struct NewOrderV2CpiBuilder<'a, 'b> {
    instruction: Box<NewOrderV2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> NewOrderV2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(NewOrderV2CpiBuilderInstruction {
            __program: program,
            market: None,
            open_orders: None,
            request_queue: None,
    ...
    #[inline(always)]
    pub fn self_trade_behavior(&mut self, self_trade_behavior: SelfTradeBehavior) -> &mut Self {
        self.instruction.self_trade_behavior = Some(self_trade_behavior);
        self
    }
    /// Add an additional account to the instruction.
    #[inline(always)]
...
#[derive(Clone, Debug)]
struct NewOrderV2CpiBuilderInstruction<'a, 'b> {
