...
impl CollectProtocolFee {
  pub fn instruction(&self, args: CollectProtocolFeeInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CollectProtocolFeeInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
#[inline(always)]
    pub fn vault1_mint(&mut self, vault1_mint: solana_pubkey::Pubkey) -> &mut Self {
            ...
            /// The address that receives the collected token_0 protocol fees
#[inline(always)]
    pub fn recipient_token0_account(&mut self, recipient_token0_account: solana_pubkey::Pubkey) -> &mut Self {
                        self.recipient_token0_account = Some(recipient_token0_account);
                    self
    }
            /// The address that receives the collected token_1 protocol fees
#[inline(always)]
    pub fn recipient_token1_account(&mut self, recipient_token1_account: solana_pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = CollectProtocolFee {
                              owner: self.owner.expect("owner is not set"),
                                        ...
                                        recipient_token0_account: self.recipient_token0_account.expect("recipient_token0_account is not set"),
                                        recipient_token1_account: self.recipient_token1_account.expect("recipient_token1_account is not set"),
                                        token_program: self.token_program.unwrap_or(solana_pubkey::pubkey!("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA")),
                                        token_program2022: self.token_program2022.unwrap_or(solana_pubkey::pubkey!("TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb")),
                      };
          let args = CollectProtocolFeeInstructionArgs {
                                                              amount0_requested: self.amount0_requested.clone().expect("amount0_requested is not set"),
                                                                  amount1_requested: self.amount1_requested.clone().expect("amount1_requested is not set"),
                                    };
...
#[inline(always)]
    pub fn token1_vault(&mut self, token1_vault: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// The mint of token_0 vault
#[inline(always)]
    pub fn vault0_mint(&mut self, vault0_mint: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.vault0_mint = Some(vault0_mint);
                    self
    }
      /// The mint of token_1 vault
#[inline(always)]
    pub fn vault1_mint(&mut self, vault1_mint: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.vault1_mint = Some(vault1_mint);
                    self
    }
      /// The address that receives the collected token_0 protocol fees
#[inline(always)]
    pub fn recipient_token0_account(&mut self, recipient_token0_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.recipient_token0_account = Some(recipient_token0_account);
                    self
    }
      /// The address that receives the collected token_1 protocol fees
#[inline(always)]
    pub fn recipient_token1_account(&mut self, recipient_token1_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
    pub fn token_program(&mut self, token_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// The SPL program 2022 to perform token transfers
#[inline(always)]
    pub fn token_program2022(&mut self, token_program2022: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = CollectProtocolFeeInstructionArgs {
                                                              amount0_requested: self.instruction.amount0_requested.clone().expect("amount0_requested is not set"),
                                                                  amount1_requested: self.instruction.amount1_requested.clone().expect("amount1_requested is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          vault0_mint: self.instruction.vault0_mint.expect("vault0_mint is not set"),
                  
          vault1_mint: self.instruction.vault1_mint.expect("vault1_mint is not set"),
                  
          recipient_token0_account: self.instruction.recipient_token0_account.expect("recipient_token0_account is not set"),
                  
          recipient_token1_account: self.instruction.recipient_token1_account.expect("recipient_token1_account is not set"),
