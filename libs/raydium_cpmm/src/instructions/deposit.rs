    ...
    let accounts = Deposit {
          ...
          let args = DepositInstructionArgs {
                                                              lp_token_amount: self.lp_token_amount.clone().expect("lp_token_amount is not set"),
                                                                  maximum_token0_amount: self.maximum_token0_amount.clone().expect("maximum_token0_amount is not set"),
                                                                  maximum_token1_amount: self.maximum_token1_amount.clone().expect("maximum_token1_amount is not set"),
                                    };
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = DepositInstructionArgs {
                                                              lp_token_amount: self.instruction.lp_token_amount.clone().expect("lp_token_amount is not set"),
                                                                  maximum_token0_amount: self.instruction.maximum_token0_amount.clone().expect("maximum_token0_amount is not set"),
                                                                  maximum_token1_amount: self.instruction.maximum_token1_amount.clone().expect("maximum_token1_amount is not set"),
                                    };
