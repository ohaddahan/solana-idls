  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = Initialize {
                              creator: self.creator.expect("creator is not set"),
                                        ...
                                        create_pool_fee: self.create_pool_fee.unwrap_or(solana_pubkey::pubkey!("DNXgeM9EiiaAbaWvwjHj9fQQLAX5ZsfHyvmYUNRAdNC8")),
...
#[inline(always)]
    pub fn lp_mint(&mut self, lp_mint: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// payer token0 account
#[inline(always)]
    pub fn creator_token0(&mut self, creator_token0: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.creator_token0 = Some(creator_token0);
                    self
    }
      /// creator token1 account
#[inline(always)]
    pub fn creator_token1(&mut self, creator_token1: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.creator_token1 = Some(creator_token1);
                    self
    }
      /// creator lp token account
#[inline(always)]
    pub fn creator_lp_token(&mut self, creator_lp_token: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn token1_vault(&mut self, token1_vault: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// create pool fee account
#[inline(always)]
    pub fn create_pool_fee(&mut self, create_pool_fee: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
    pub fn token_program(&mut self, token_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Spl token program or token program 2022
#[inline(always)]
    pub fn token0_program(&mut self, token0_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.token0_program = Some(token0_program);
                    self
    }
      /// Spl token program or token program 2022
#[inline(always)]
    pub fn token1_program(&mut self, token1_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = InitializeInstructionArgs {
                                                              init_amount0: self.instruction.init_amount0.clone().expect("init_amount0 is not set"),
                                                                  init_amount1: self.instruction.init_amount1.clone().expect("init_amount1 is not set"),
        ...
        __program: self.instruction.__program,
          ...
          creator_token0: self.instruction.creator_token0.expect("creator_token0 is not set"),
                  
          creator_token1: self.instruction.creator_token1.expect("creator_token1 is not set"),
                  
          creator_lp_token: self.instruction.creator_lp_token.expect("creator_lp_token is not set"),
          ...
          create_pool_fee: self.instruction.create_pool_fee.expect("create_pool_fee is not set"),
                  
          observation_state: self.instruction.observation_state.expect("observation_state is not set"),
                  
          token_program: self.instruction.token_program.expect("token_program is not set"),
                  
          token0_program: self.instruction.token0_program.expect("token0_program is not set"),
                  
          token1_program: self.instruction.token1_program.expect("token1_program is not set"),
