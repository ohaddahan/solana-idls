...
impl SwapBaseOutput {
  pub fn instruction(&self, args: SwapBaseOutputInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SwapBaseOutputInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
#[inline(always)]
    pub fn input_token_account(&mut self, input_token_account: solana_pubkey::Pubkey) -> &mut Self {
            ...
            /// The user token account for output token
#[inline(always)]
    pub fn output_token_account(&mut self, output_token_account: solana_pubkey::Pubkey) -> &mut Self {
...
#[inline(always)]
    pub fn input_token_program(&mut self, input_token_program: solana_pubkey::Pubkey) -> &mut Self {
            ...
            /// SPL program for output token transfers
#[inline(always)]
    pub fn output_token_program(&mut self, output_token_program: solana_pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = SwapBaseOutput {
                              payer: self.payer.expect("payer is not set"),
                                        ...
                                        output_token_account: self.output_token_account.expect("output_token_account is not set"),
                                        ...
                                        output_token_program: self.output_token_program.expect("output_token_program is not set"),
                                        input_token_mint: self.input_token_mint.expect("input_token_mint is not set"),
                                        output_token_mint: self.output_token_mint.expect("output_token_mint is not set"),
                                        observation_state: self.observation_state.expect("observation_state is not set"),
                      };
...
#[inline(always)]
    pub fn amm_config(&mut self, amm_config: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// The program account of the pool in which the swap will be performed
#[inline(always)]
    pub fn pool_state(&mut self, pool_state: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
    pub fn input_token_account(&mut self, input_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// The user token account for output token
#[inline(always)]
    pub fn output_token_account(&mut self, output_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.output_token_account = Some(output_token_account);
                    self
    }
      /// The vault token account for input token
#[inline(always)]
    pub fn input_vault(&mut self, input_vault: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.input_vault = Some(input_vault);
                    self
    }
      /// The vault token account for output token
#[inline(always)]
    pub fn output_vault(&mut self, output_vault: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
    pub fn input_token_program(&mut self, input_token_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// SPL program for output token transfers
#[inline(always)]
    pub fn output_token_program(&mut self, output_token_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
    pub fn input_token_mint(&mut self, input_token_mint: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// The mint of output token
#[inline(always)]
    pub fn output_token_mint(&mut self, output_token_mint: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.output_token_mint = Some(output_token_mint);
                    self
    }
      /// The program account for the most recent oracle observation
#[inline(always)]
    pub fn observation_state(&mut self, observation_state: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          output_token_account: self.instruction.output_token_account.expect("output_token_account is not set"),
                  
          input_vault: self.instruction.input_vault.expect("input_vault is not set"),
                  
          output_vault: self.instruction.output_vault.expect("output_vault is not set"),
                  
          input_token_program: self.instruction.input_token_program.expect("input_token_program is not set"),
                  
          output_token_program: self.instruction.output_token_program.expect("output_token_program is not set"),
                  
          input_token_mint: self.instruction.input_token_mint.expect("input_token_mint is not set"),
                  
          output_token_mint: self.instruction.output_token_mint.expect("output_token_mint is not set"),
                  
          observation_state: self.instruction.observation_state.expect("observation_state is not set"),
                          __args: args,
            };
