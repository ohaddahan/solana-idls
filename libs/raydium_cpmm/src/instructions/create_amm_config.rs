...
impl CreateAmmConfig {
  pub fn instruction(&self, args: CreateAmmConfigInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CreateAmmConfigInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = CreateAmmConfig {
                              owner: self.owner.unwrap_or(solana_pubkey::pubkey!("GThUX1Atko4tqhN2NaiTazWSeFWMuiUvfFnyJyUghFMJ")),
          ...
          let args = CreateAmmConfigInstructionArgs {
                                                              index: self.index.clone().expect("index is not set"),
                                                                  trade_fee_rate: self.trade_fee_rate.clone().expect("trade_fee_rate is not set"),
                                                                  protocol_fee_rate: self.protocol_fee_rate.clone().expect("protocol_fee_rate is not set"),
                                                                  fund_fee_rate: self.fund_fee_rate.clone().expect("fund_fee_rate is not set"),
                                                                  create_pool_fee: self.create_pool_fee.clone().expect("create_pool_fee is not set"),
                                    };
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = CreateAmmConfigInstructionArgs {
                                                              index: self.instruction.index.clone().expect("index is not set"),
                                                                  trade_fee_rate: self.instruction.trade_fee_rate.clone().expect("trade_fee_rate is not set"),
                                                                  protocol_fee_rate: self.instruction.protocol_fee_rate.clone().expect("protocol_fee_rate is not set"),
                                                                  fund_fee_rate: self.instruction.fund_fee_rate.clone().expect("fund_fee_rate is not set"),
                                                                  create_pool_fee: self.instruction.create_pool_fee.clone().expect("create_pool_fee is not set"),
                                    };
