...
impl Initialize2 {
  ...
  pub fn instruction_with_remaining_accounts(&self, args: Initialize2InstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
#[inline(always)]
    pub fn token_program(&mut self, token_program: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn spl_associated_token_account(&mut self, spl_associated_token_account: solana_pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = Initialize2 {
                              token_program: self.token_program.unwrap_or(solana_pubkey::pubkey!("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA")),
                                        spl_associated_token_account: self.spl_associated_token_account.expect("spl_associated_token_account is not set"),
          ...
          let args = Initialize2InstructionArgs {
                                                              nonce: self.nonce.clone().expect("nonce is not set"),
                                                                  ...
                                                                  init_pc_amount: self.init_pc_amount.clone().expect("init_pc_amount is not set"),
                                                                  init_coin_amount: self.init_coin_amount.clone().expect("init_coin_amount is not set"),
                                    };
...
impl<'a, 'b> Initialize2CpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn token_program(&mut self, token_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn spl_associated_token_account(&mut self, spl_associated_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn amm_target_orders(&mut self, amm_target_orders: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn pool_temp_lp(&mut self, pool_temp_lp: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn user_wallet(&mut self, user_wallet: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn user_token_coin(&mut self, user_token_coin: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.user_token_coin = Some(user_token_coin);
                    self
    }
      #[inline(always)]
    pub fn user_token_pc(&mut self, user_token_pc: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = Initialize2InstructionArgs {
                                                              nonce: self.instruction.nonce.clone().expect("nonce is not set"),
                                                                  open_time: self.instruction.open_time.clone().expect("open_time is not set"),
                                                                  init_pc_amount: self.instruction.init_pc_amount.clone().expect("init_pc_amount is not set"),
                                                                  init_coin_amount: self.instruction.init_coin_amount.clone().expect("init_coin_amount is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          spl_associated_token_account: self.instruction.spl_associated_token_account.expect("spl_associated_token_account is not set"),
          ...
          pool_temp_lp: self.instruction.pool_temp_lp.expect("pool_temp_lp is not set"),
          ...
          user_token_coin: self.instruction.user_token_coin.expect("user_token_coin is not set"),
                  
          user_token_pc: self.instruction.user_token_pc.expect("user_token_pc is not set"),
