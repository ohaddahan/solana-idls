...
#[inline(always)]
    ...
    pub fn serum_market(&mut self, serum_market: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn user_coin_token_account(&mut self, user_coin_token_account: solana_pubkey::Pubkey) -> &mut Self {
                        self.user_coin_token_account = Some(user_coin_token_account);
                    self
    }
            #[inline(always)]
    pub fn user_pc_token_account(&mut self, user_pc_token_account: solana_pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = Deposit {
                              token_program: self.token_program.unwrap_or(solana_pubkey::pubkey!("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA")),
                                        ...
                                        user_coin_token_account: self.user_coin_token_account.expect("user_coin_token_account is not set"),
                                        user_pc_token_account: self.user_pc_token_account.expect("user_pc_token_account is not set"),
          ...
          let args = DepositInstructionArgs {
                                                              max_coin_amount: self.max_coin_amount.clone().expect("max_coin_amount is not set"),
                                                                  max_pc_amount: self.max_pc_amount.clone().expect("max_pc_amount is not set"),
...
impl<'a, 'b> DepositCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn serum_market(&mut self, serum_market: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn user_coin_token_account(&mut self, user_coin_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.user_coin_token_account = Some(user_coin_token_account);
                    self
    }
      #[inline(always)]
    pub fn user_pc_token_account(&mut self, user_pc_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = DepositInstructionArgs {
                                                              max_coin_amount: self.instruction.max_coin_amount.clone().expect("max_coin_amount is not set"),
                                                                  max_pc_amount: self.instruction.max_pc_amount.clone().expect("max_pc_amount is not set"),
                                                                  base_side: self.instruction.base_side.clone().expect("base_side is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          user_coin_token_account: self.instruction.user_coin_token_account.expect("user_coin_token_account is not set"),
                  
          user_pc_token_account: self.instruction.user_pc_token_account.expect("user_pc_token_account is not set"),
