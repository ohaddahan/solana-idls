...
impl MonitorStep {
  ...
  pub fn instruction_with_remaining_accounts(&self, args: MonitorStepInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = MonitorStep {
          ...
          let args = MonitorStepInstructionArgs {
                                                              plan_order_limit: self.plan_order_limit.clone().expect("plan_order_limit is not set"),
                                                                  place_order_limit: self.place_order_limit.clone().expect("place_order_limit is not set"),
                                                                  cancel_order_limit: self.cancel_order_limit.clone().expect("cancel_order_limit is not set"),
                                    };
...
impl<'a, 'b> MonitorStepCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn serum_vault_signer(&mut self, serum_vault_signer: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn serum_req_q(&mut self, serum_req_q: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = MonitorStepInstructionArgs {
                                                              plan_order_limit: self.instruction.plan_order_limit.clone().expect("plan_order_limit is not set"),
                                                                  place_order_limit: self.instruction.place_order_limit.clone().expect("place_order_limit is not set"),
                                                                  cancel_order_limit: self.instruction.cancel_order_limit.clone().expect("cancel_order_limit is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          serum_req_q: self.instruction.serum_req_q.expect("serum_req_q is not set"),
