...
impl WithdrawSrm {
  ...
  pub fn instruction_with_remaining_accounts(&self, args: WithdrawSrmInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
impl WithdrawSrmInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [193, 101, 58, 65, 120, 78, 99, 31],
                                }
  }
}
...
impl<'a, 'b> WithdrawSrmCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn srm_token(&mut self, srm_token: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn dest_srm_token(&mut self, dest_srm_token: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          dest_srm_token: self.instruction.dest_srm_token.expect("dest_srm_token is not set"),
                          __args: args,
            };
