...
#[inline(always)]
    ...
    pub fn pool_withdraw_queue(&mut self, pool_withdraw_queue: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn pool_target_orders_account(&mut self, pool_target_orders_account: solana_pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = Initialize {
                              token_program: self.token_program.unwrap_or(solana_pubkey::pubkey!("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA")),
                                        ...
                                        coin_mint_address: self.coin_mint_address.expect("coin_mint_address is not set"),
                                        ...
                                        pool_target_orders_account: self.pool_target_orders_account.expect("pool_target_orders_account is not set"),
...
impl<'a, 'b> InitializeCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn lp_mint_address(&mut self, lp_mint_address: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn coin_mint_address(&mut self, coin_mint_address: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.coin_mint_address = Some(coin_mint_address);
                    self
    }
      #[inline(always)]
    pub fn pc_mint_address(&mut self, pc_mint_address: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn pool_withdraw_queue(&mut self, pool_withdraw_queue: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn pool_target_orders_account(&mut self, pool_target_orders_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          coin_mint_address: self.instruction.coin_mint_address.expect("coin_mint_address is not set"),
                  
          pc_mint_address: self.instruction.pc_mint_address.expect("pc_mint_address is not set"),
          ...
          pool_target_orders_account: self.instruction.pool_target_orders_account.expect("pool_target_orders_account is not set"),
