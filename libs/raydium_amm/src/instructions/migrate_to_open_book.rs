  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = MigrateToOpenBook {
                              token_program: self.token_program.unwrap_or(solana_pubkey::pubkey!("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA")),
                                        ...
                                        new_amm_open_orders: self.new_amm_open_orders.expect("new_amm_open_orders is not set"),
                                        new_serum_program: self.new_serum_program.expect("new_serum_program is not set"),
...
impl<'a, 'b> MigrateToOpenBookCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn amm_open_orders(&mut self, amm_open_orders: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn amm_token_coin(&mut self, amm_token_coin: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.amm_token_coin = Some(amm_token_coin);
                    self
    }
      #[inline(always)]
    pub fn amm_token_pc(&mut self, amm_token_pc: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn serum_event_queue(&mut self, serum_event_queue: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn serum_coin_vault(&mut self, serum_coin_vault: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.serum_coin_vault = Some(serum_coin_vault);
                    self
    }
      #[inline(always)]
    pub fn serum_pc_vault(&mut self, serum_pc_vault: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn serum_vault_signer(&mut self, serum_vault_signer: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn new_amm_open_orders(&mut self, new_amm_open_orders: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.new_amm_open_orders = Some(new_amm_open_orders);
                    self
    }
      #[inline(always)]
    pub fn new_serum_program(&mut self, new_serum_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.new_serum_program = Some(new_serum_program);
                    self
    }
      #[inline(always)]
    pub fn new_serum_market(&mut self, new_serum_market: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          amm_token_coin: self.instruction.amm_token_coin.expect("amm_token_coin is not set"),
                  
          amm_token_pc: self.instruction.amm_token_pc.expect("amm_token_pc is not set"),
          ...
          serum_coin_vault: self.instruction.serum_coin_vault.expect("serum_coin_vault is not set"),
                  
          serum_pc_vault: self.instruction.serum_pc_vault.expect("serum_pc_vault is not set"),
                  
          serum_vault_signer: self.instruction.serum_vault_signer.expect("serum_vault_signer is not set"),
                  
          new_amm_open_orders: self.instruction.new_amm_open_orders.expect("new_amm_open_orders is not set"),
                  
          new_serum_program: self.instruction.new_serum_program.expect("new_serum_program is not set"),
                  
          new_serum_market: self.instruction.new_serum_market.expect("new_serum_market is not set"),
