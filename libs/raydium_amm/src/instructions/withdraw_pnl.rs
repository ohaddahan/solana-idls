...
#[inline(always)]
    ...
    pub fn pool_pc_token_account(&mut self, pool_pc_token_account: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn coin_pnl_token_account(&mut self, coin_pnl_token_account: solana_pubkey::Pubkey) -> &mut Self {
                        self.coin_pnl_token_account = Some(coin_pnl_token_account);
                    self
    }
            #[inline(always)]
    pub fn pc_pnl_token_account(&mut self, pc_pnl_token_account: solana_pubkey::Pubkey) -> &mut Self {
...
impl<'a, 'b> WithdrawPnlCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn pool_pc_token_account(&mut self, pool_pc_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn coin_pnl_token_account(&mut self, coin_pnl_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.coin_pnl_token_account = Some(coin_pnl_token_account);
                    self
    }
      #[inline(always)]
    pub fn pc_pnl_token_account(&mut self, pc_pnl_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.pc_pnl_token_account = Some(pc_pnl_token_account);
                    self
    }
      #[inline(always)]
    pub fn pnl_owner_account(&mut self, pnl_owner_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
