...
impl SwapBaseOut {
  ...
  pub fn instruction_with_remaining_accounts(&self, args: SwapBaseOutInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
impl SwapBaseOutInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [163, 210, 155, 208, 175, 146, 213, 150],
                                              }
  }
}
...
#[inline(always)]
    ...
    pub fn serum_vault_signer(&mut self, serum_vault_signer: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn uer_source_token_account(&mut self, uer_source_token_account: solana_pubkey::Pubkey) -> &mut Self {
                        self.uer_source_token_account = Some(uer_source_token_account);
                    self
    }
            #[inline(always)]
    pub fn uer_destination_token_account(&mut self, uer_destination_token_account: solana_pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = SwapBaseOut {
                              token_program: self.token_program.unwrap_or(solana_pubkey::pubkey!("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA")),
                                        ...
                                        uer_source_token_account: self.uer_source_token_account.expect("uer_source_token_account is not set"),
                                        uer_destination_token_account: self.uer_destination_token_account.expect("uer_destination_token_account is not set"),
                                        user_source_owner: self.user_source_owner.expect("user_source_owner is not set"),
                      };
          let args = SwapBaseOutInstructionArgs {
                                                              max_amount_in: self.max_amount_in.clone().expect("max_amount_in is not set"),
...
impl<'a, 'b> SwapBaseOutCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn serum_asks(&mut self, serum_asks: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn serum_event_queue(&mut self, serum_event_queue: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn serum_vault_signer(&mut self, serum_vault_signer: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn uer_source_token_account(&mut self, uer_source_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.uer_source_token_account = Some(uer_source_token_account);
                    self
    }
      #[inline(always)]
    pub fn uer_destination_token_account(&mut self, uer_destination_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.uer_destination_token_account = Some(uer_destination_token_account);
                    self
    }
      #[inline(always)]
    pub fn user_source_owner(&mut self, user_source_owner: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = SwapBaseOutInstructionArgs {
                                                              max_amount_in: self.instruction.max_amount_in.clone().expect("max_amount_in is not set"),
                                                                  amount_out: self.instruction.amount_out.clone().expect("amount_out is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          uer_source_token_account: self.instruction.uer_source_token_account.expect("uer_source_token_account is not set"),
                  
          uer_destination_token_account: self.instruction.uer_destination_token_account.expect("uer_destination_token_account is not set"),
                  
          user_source_owner: self.instruction.user_source_owner.expect("user_source_owner is not set"),
                          __args: args,
            };
