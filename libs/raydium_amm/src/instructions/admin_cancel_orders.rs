...
impl AdminCancelOrders {
  pub fn instruction(&self, args: AdminCancelOrdersInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: AdminCancelOrdersInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = AdminCancelOrders {
                              token_program: self.token_program.unwrap_or(solana_pubkey::pubkey!("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA")),
                                        ...
                                        amm_owner_account: self.amm_owner_account.expect("amm_owner_account is not set"),
...
impl<'a, 'b> AdminCancelOrdersCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn pool_pc_token_account(&mut self, pool_pc_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn amm_owner_account(&mut self, amm_owner_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.amm_owner_account = Some(amm_owner_account);
                    self
    }
      #[inline(always)]
    pub fn amm_config(&mut self, amm_config: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          amm_owner_account: self.instruction.amm_owner_account.expect("amm_owner_account is not set"),
