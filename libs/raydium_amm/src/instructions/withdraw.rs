...
#[inline(always)]
    ...
    pub fn lp_mint_address(&mut self, lp_mint_address: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn pool_coin_token_account(&mut self, pool_coin_token_account: solana_pubkey::Pubkey) -> &mut Self {
                        self.pool_coin_token_account = Some(pool_coin_token_account);
                    self
    }
            #[inline(always)]
    pub fn pool_pc_token_account(&mut self, pool_pc_token_account: solana_pubkey::Pubkey) -> &mut Self {
    ...
    pub fn pool_withdraw_queue(&mut self, pool_withdraw_queue: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn pool_temp_lp_token_account(&mut self, pool_temp_lp_token_account: solana_pubkey::Pubkey) -> &mut Self {
    ...
    pub fn serum_market(&mut self, serum_market: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn serum_coin_vault_account(&mut self, serum_coin_vault_account: solana_pubkey::Pubkey) -> &mut Self {
                        self.serum_coin_vault_account = Some(serum_coin_vault_account);
                    self
    }
            #[inline(always)]
    pub fn serum_pc_vault_account(&mut self, serum_pc_vault_account: solana_pubkey::Pubkey) -> &mut Self {
    ...
    pub fn serum_vault_signer(&mut self, serum_vault_signer: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn user_lp_token_account(&mut self, user_lp_token_account: solana_pubkey::Pubkey) -> &mut Self {
                        self.user_lp_token_account = Some(user_lp_token_account);
                    self
    }
            #[inline(always)]
    pub fn uer_coin_token_account(&mut self, uer_coin_token_account: solana_pubkey::Pubkey) -> &mut Self {
                        self.uer_coin_token_account = Some(uer_coin_token_account);
                    self
    }
            #[inline(always)]
    pub fn uer_pc_token_account(&mut self, uer_pc_token_account: solana_pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = Withdraw {
                              token_program: self.token_program.unwrap_or(solana_pubkey::pubkey!("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA")),
                                        ...
                                        pool_withdraw_queue: self.pool_withdraw_queue.expect("pool_withdraw_queue is not set"),
                                        pool_temp_lp_token_account: self.pool_temp_lp_token_account.expect("pool_temp_lp_token_account is not set"),
                                        ...
                                        user_lp_token_account: self.user_lp_token_account.expect("user_lp_token_account is not set"),
                                        uer_coin_token_account: self.uer_coin_token_account.expect("uer_coin_token_account is not set"),
                                        uer_pc_token_account: self.uer_pc_token_account.expect("uer_pc_token_account is not set"),
...
impl<'a, 'b> WithdrawCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn amm(&mut self, amm: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn amm_authority(&mut self, amm_authority: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.amm_authority = Some(amm_authority);
                    self
    }
      #[inline(always)]
    pub fn amm_open_orders(&mut self, amm_open_orders: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.amm_open_orders = Some(amm_open_orders);
                    self
    }
      #[inline(always)]
    pub fn amm_target_orders(&mut self, amm_target_orders: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.amm_target_orders = Some(amm_target_orders);
                    self
    }
      #[inline(always)]
    pub fn lp_mint_address(&mut self, lp_mint_address: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.lp_mint_address = Some(lp_mint_address);
                    self
    }
      #[inline(always)]
    pub fn pool_coin_token_account(&mut self, pool_coin_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.pool_coin_token_account = Some(pool_coin_token_account);
                    self
    }
      #[inline(always)]
    pub fn pool_pc_token_account(&mut self, pool_pc_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.pool_pc_token_account = Some(pool_pc_token_account);
                    self
    }
      #[inline(always)]
    pub fn pool_withdraw_queue(&mut self, pool_withdraw_queue: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.pool_withdraw_queue = Some(pool_withdraw_queue);
                    self
    }
      #[inline(always)]
    pub fn pool_temp_lp_token_account(&mut self, pool_temp_lp_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.pool_temp_lp_token_account = Some(pool_temp_lp_token_account);
                    self
    }
      #[inline(always)]
    pub fn serum_program(&mut self, serum_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.serum_program = Some(serum_program);
                    self
    }
      #[inline(always)]
    pub fn serum_market(&mut self, serum_market: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.serum_market = Some(serum_market);
                    self
    }
      #[inline(always)]
    pub fn serum_coin_vault_account(&mut self, serum_coin_vault_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.serum_coin_vault_account = Some(serum_coin_vault_account);
                    self
    }
      #[inline(always)]
    pub fn serum_pc_vault_account(&mut self, serum_pc_vault_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.serum_pc_vault_account = Some(serum_pc_vault_account);
                    self
    }
      #[inline(always)]
    pub fn serum_vault_signer(&mut self, serum_vault_signer: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.serum_vault_signer = Some(serum_vault_signer);
                    self
    }
      #[inline(always)]
    pub fn user_lp_token_account(&mut self, user_lp_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.user_lp_token_account = Some(user_lp_token_account);
                    self
    }
      #[inline(always)]
    pub fn uer_coin_token_account(&mut self, uer_coin_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.uer_coin_token_account = Some(uer_coin_token_account);
                    self
    }
      #[inline(always)]
    pub fn uer_pc_token_account(&mut self, uer_pc_token_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.uer_pc_token_account = Some(uer_pc_token_account);
                    self
    }
      #[inline(always)]
    pub fn user_owner(&mut self, user_owner: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.user_owner = Some(user_owner);
                    self
    }
      #[inline(always)]
    pub fn serum_event_q(&mut self, serum_event_q: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.serum_event_q = Some(serum_event_q);
                    self
    }
      #[inline(always)]
    pub fn serum_bids(&mut self, serum_bids: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.serum_bids = Some(serum_bids);
                    self
    }
      #[inline(always)]
    pub fn serum_asks(&mut self, serum_asks: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          lp_mint_address: self.instruction.lp_mint_address.expect("lp_mint_address is not set"),
          ...
          pool_withdraw_queue: self.instruction.pool_withdraw_queue.expect("pool_withdraw_queue is not set"),
                  
          pool_temp_lp_token_account: self.instruction.pool_temp_lp_token_account.expect("pool_temp_lp_token_account is not set"),
          ...
          user_lp_token_account: self.instruction.user_lp_token_account.expect("user_lp_token_account is not set"),
                  
          uer_coin_token_account: self.instruction.uer_coin_token_account.expect("uer_coin_token_account is not set"),
                  
          uer_pc_token_account: self.instruction.uer_pc_token_account.expect("uer_pc_token_account is not set"),
                  
          user_owner: self.instruction.user_owner.expect("user_owner is not set"),
                  
          serum_event_q: self.instruction.serum_event_q.expect("serum_event_q is not set"),
