...
impl SwapBaseIn {
  ...
  pub fn instruction_with_remaining_accounts(&self, args: SwapBaseInInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
