...
impl QueueResetVault {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&QueueResetVaultInstructionData::new()).unwrap();
...
pub struct QueueResetVaultInstructionData {
    discriminator: [u8; 8],
}

impl QueueResetVaultInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for QueueResetVaultInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `QueueResetVault`.
///
/// ### Accounts:
///
///   0. `[writable]` queue
...
pub struct QueueResetVaultBuilder {
...
/// `queue_reset_vault` CPI accounts.
pub struct QueueResetVaultCpiAccounts<'a, 'b> {
...
/// `queue_reset_vault` CPI instruction.
pub struct QueueResetVaultCpi<'a, 'b> {
...
impl<'a, 'b> QueueResetVaultCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: QueueResetVaultCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `QueueResetVault` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` queue
...
///   4. `[]` vault
#[derive(Clone, Debug)]
pub struct QueueResetVaultCpiBuilder<'a, 'b> {
    instruction: Box<QueueResetVaultCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> QueueResetVaultCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(QueueResetVaultCpiBuilderInstruction {
            __program: program,
            queue: None,
            authority: None,
            state: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = QueueResetVaultCpi {
...
#[derive(Clone, Debug)]
struct QueueResetVaultCpiBuilderInstruction<'a, 'b> {
