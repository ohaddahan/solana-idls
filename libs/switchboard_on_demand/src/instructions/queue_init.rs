...
impl QueueInit {
    pub fn instruction(&self, args: QueueInitInstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        &self,
        args: QueueInitInstructionArgs,
        remaining_accounts: &[solana_instruction::AccountMeta],
    ) -> solana_instruction::Instruction {
        let mut accounts = Vec::with_capacity(12 + remaining_accounts.len());
        accounts.push(solana_instruction::AccountMeta::new(self.queue, true));
        ...
        let mut data = borsh::to_vec(&QueueInitInstructionData::new()).unwrap();
...
pub struct QueueInitInstructionData {
    discriminator: [u8; 8],
}

impl QueueInitInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for QueueInitInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct QueueInitInstructionArgs {
...
/// Instruction builder for `QueueInit`.
///
/// ### Accounts:
///
///   0. `[writable, signer]` queue
...
impl QueueInitBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = QueueInitInstructionArgs {
...
/// `queue_init` CPI accounts.
pub struct QueueInitCpiAccounts<'a, 'b> {
...
/// `queue_init` CPI instruction.
pub struct QueueInitCpi<'a, 'b> {
    ...
    pub __args: QueueInitInstructionArgs,
}

impl<'a, 'b> QueueInitCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: QueueInitCpiAccounts<'a, 'b>,
        args: QueueInitInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        let mut accounts = Vec::with_capacity(12 + remaining_accounts.len());
        accounts.push(solana_instruction::AccountMeta::new(*self.queue.key, true));
        accounts.push(solana_instruction::AccountMeta::new(
...
/// Instruction builder for `QueueInit` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` queue
...
#[derive(Clone, Debug)]
pub struct QueueInitCpiBuilder<'a, 'b> {
    instruction: Box<QueueInitCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> QueueInitCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(QueueInitCpiBuilderInstruction {
            __program: program,
            queue: None,
            queue_escrow: None,
            authority: None,
...
#[derive(Clone, Debug)]
struct QueueInitCpiBuilderInstruction<'a, 'b> {
