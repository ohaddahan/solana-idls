...
impl GuardianUnregister {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&GuardianUnregisterInstructionData::new()).unwrap();
...
pub struct GuardianUnregisterInstructionData {
    discriminator: [u8; 8],
}

impl GuardianUnregisterInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for GuardianUnregisterInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `GuardianUnregister`.
///
/// ### Accounts:
///
///   0. `[writable]` oracle
///   1. `[]` state
///   2. `[writable]` guardian_queue
///   3. `[signer]` authority
#[derive(Clone, Debug, Default)]
pub struct GuardianUnregisterBuilder {
...
impl GuardianUnregisterBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = GuardianUnregister {
...
/// `guardian_unregister` CPI accounts.
pub struct GuardianUnregisterCpiAccounts<'a, 'b> {
...
/// `guardian_unregister` CPI instruction.
pub struct GuardianUnregisterCpi<'a, 'b> {
...
impl<'a, 'b> GuardianUnregisterCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: GuardianUnregisterCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `GuardianUnregister` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` oracle
...
///   3. `[signer]` authority
#[derive(Clone, Debug)]
pub struct GuardianUnregisterCpiBuilder<'a, 'b> {
    instruction: Box<GuardianUnregisterCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> GuardianUnregisterCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(GuardianUnregisterCpiBuilderInstruction {
            __program: program,
            oracle: None,
            state: None,
            guardian_queue: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = GuardianUnregisterCpi {
...
#[derive(Clone, Debug)]
struct GuardianUnregisterCpiBuilderInstruction<'a, 'b> {
