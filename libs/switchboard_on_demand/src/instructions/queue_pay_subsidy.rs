...
pub struct QueuePaySubsidy {
    ...
    pub subsidy_vault: solana_pubkey::Pubkey,
    ...
    pub switch_mint: solana_pubkey::Pubkey,

    pub vault_config: solana_pubkey::Pubkey,
...
impl QueuePaySubsidy {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&QueuePaySubsidyInstructionData::new()).unwrap();
...
pub struct QueuePaySubsidyInstructionData {
    discriminator: [u8; 8],
}

impl QueuePaySubsidyInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for QueuePaySubsidyInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `QueuePaySubsidy`.
///
/// ### Accounts:
///
///   0. `[writable]` queue
...
pub struct QueuePaySubsidyBuilder {
    ...
    subsidy_vault: Option<solana_pubkey::Pubkey>,
    token_program: Option<solana_pubkey::Pubkey>,
    associated_token_program: Option<solana_pubkey::Pubkey>,
    wsol_mint: Option<solana_pubkey::Pubkey>,
    switch_mint: Option<solana_pubkey::Pubkey>,
    vault_config: Option<solana_pubkey::Pubkey>,
    payer: Option<solana_pubkey::Pubkey>,
    __remaining_accounts: Vec<solana_instruction::AccountMeta>,
}

impl QueuePaySubsidyBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn subsidy_vault(&mut self, subsidy_vault: solana_pubkey::Pubkey) -> &mut Self {
        self.subsidy_vault = Some(subsidy_vault);
        self
    }
    ...
    #[inline(always)]
    pub fn switch_mint(&mut self, switch_mint: solana_pubkey::Pubkey) -> &mut Self {
        self.switch_mint = Some(switch_mint);
        self
    }
    #[inline(always)]
    pub fn vault_config(&mut self, vault_config: solana_pubkey::Pubkey) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = QueuePaySubsidy {
            ...
            subsidy_vault: self.subsidy_vault.expect("subsidy_vault is not set"),
            ...
            switch_mint: self.switch_mint.expect("switch_mint is not set"),
...
/// `queue_pay_subsidy` CPI accounts.
pub struct QueuePaySubsidyCpiAccounts<'a, 'b> {
    ...
    pub subsidy_vault: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub switch_mint: &'b solana_account_info::AccountInfo<'a>,
...
/// `queue_pay_subsidy` CPI instruction.
pub struct QueuePaySubsidyCpi<'a, 'b> {
...
impl<'a, 'b> QueuePaySubsidyCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: QueuePaySubsidyCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
            ...
            subsidy_vault: accounts.subsidy_vault,
            token_program: accounts.token_program,
            associated_token_program: accounts.associated_token_program,
            wsol_mint: accounts.wsol_mint,
            switch_mint: accounts.switch_mint,
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        account_infos.push(self.subsidy_vault.clone());
        account_infos.push(self.token_program.clone());
        account_infos.push(self.associated_token_program.clone());
        account_infos.push(self.wsol_mint.clone());
        account_infos.push(self.switch_mint.clone());
...
/// Instruction builder for `QueuePaySubsidy` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` queue
...
///   11. `[writable, signer]` payer
#[derive(Clone, Debug)]
pub struct QueuePaySubsidyCpiBuilder<'a, 'b> {
    instruction: Box<QueuePaySubsidyCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> QueuePaySubsidyCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(QueuePaySubsidyCpiBuilderInstruction {
            __program: program,
            queue: None,
            program_state: None,
            system_program: None,
    ...
    #[inline(always)]
    pub fn subsidy_vault(
        &mut self,
        subsidy_vault: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction.subsidy_vault = Some(subsidy_vault);
        self
    }
    #[inline(always)]
    ...
    pub fn switch_mint(
        &mut self,
        switch_mint: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn invoke_signed(
        ...
        let instruction = QueuePaySubsidyCpi {
            ...
            subsidy_vault: self
                .instruction
                .subsidy_vault
                .expect("subsidy_vault is not set"),
...
#[derive(Clone, Debug)]
struct QueuePaySubsidyCpiBuilderInstruction<'a, 'b> {
    ...
    subsidy_vault: Option<&'b solana_account_info::AccountInfo<'a>>,
    token_program: Option<&'b solana_account_info::AccountInfo<'a>>,
    associated_token_program: Option<&'b solana_account_info::AccountInfo<'a>>,
    wsol_mint: Option<&'b solana_account_info::AccountInfo<'a>>,
    switch_mint: Option<&'b solana_account_info::AccountInfo<'a>>,
