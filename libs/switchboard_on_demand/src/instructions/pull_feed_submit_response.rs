...
use crate::types::SbOnDemandActionsPullFeedPullFeedSubmitResponseActionSubmission;
...
impl PullFeedSubmitResponse {
    pub fn instruction(
        &self,
        args: PullFeedSubmitResponseInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&PullFeedSubmitResponseInstructionData::new()).unwrap();
...
pub struct PullFeedSubmitResponseInstructionData {
    discriminator: [u8; 8],
}

impl PullFeedSubmitResponseInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for PullFeedSubmitResponseInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct PullFeedSubmitResponseInstructionArgs {
    pub slot: u64,
    pub submissions: Vec<SbOnDemandActionsPullFeedPullFeedSubmitResponseActionSubmission>,
}

/// Instruction builder for `PullFeedSubmitResponse`.
///
/// ### Accounts:
///
///   0. `[writable]` feed
...
pub struct PullFeedSubmitResponseBuilder {
    ...
    slot: Option<u64>,
    submissions: Option<Vec<SbOnDemandActionsPullFeedPullFeedSubmitResponseActionSubmission>>,
    __remaining_accounts: Vec<solana_instruction::AccountMeta>,
}

impl PullFeedSubmitResponseBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn submissions(
        &mut self,
        submissions: Vec<SbOnDemandActionsPullFeedPullFeedSubmitResponseActionSubmission>,
    ) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = PullFeedSubmitResponse {
        ...
        let args = PullFeedSubmitResponseInstructionArgs {
...
/// `pull_feed_submit_response` CPI accounts.
pub struct PullFeedSubmitResponseCpiAccounts<'a, 'b> {
...
/// `pull_feed_submit_response` CPI instruction.
pub struct PullFeedSubmitResponseCpi<'a, 'b> {
    ...
    pub __args: PullFeedSubmitResponseInstructionArgs,
}

impl<'a, 'b> PullFeedSubmitResponseCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: PullFeedSubmitResponseCpiAccounts<'a, 'b>,
        args: PullFeedSubmitResponseInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `PullFeedSubmitResponse` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` feed
...
///   8. `[]` token_mint
#[derive(Clone, Debug)]
pub struct PullFeedSubmitResponseCpiBuilder<'a, 'b> {
    instruction: Box<PullFeedSubmitResponseCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> PullFeedSubmitResponseCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(PullFeedSubmitResponseCpiBuilderInstruction {
            __program: program,
            feed: None,
            queue: None,
            program_state: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = PullFeedSubmitResponseCpi {
...
#[derive(Clone, Debug)]
struct PullFeedSubmitResponseCpiBuilderInstruction<'a, 'b> {
