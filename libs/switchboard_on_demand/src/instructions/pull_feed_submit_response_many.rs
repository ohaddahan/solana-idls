...
use crate::types::MultiSubmission;
...
impl PullFeedSubmitResponseMany {
    pub fn instruction(
        &self,
        args: PullFeedSubmitResponseManyInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&PullFeedSubmitResponseManyInstructionData::new()).unwrap();
...
pub struct PullFeedSubmitResponseManyInstructionData {
    discriminator: [u8; 8],
}

impl PullFeedSubmitResponseManyInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for PullFeedSubmitResponseManyInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct PullFeedSubmitResponseManyInstructionArgs {
    pub slot: u64,
    pub submissions: Vec<MultiSubmission>,
}

/// Instruction builder for `PullFeedSubmitResponseMany`.
///
/// ### Accounts:
///
///   0. `[]` queue
...
pub struct PullFeedSubmitResponseManyBuilder {
    ...
    slot: Option<u64>,
    submissions: Option<Vec<MultiSubmission>>,
    __remaining_accounts: Vec<solana_instruction::AccountMeta>,
}

impl PullFeedSubmitResponseManyBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn submissions(&mut self, submissions: Vec<MultiSubmission>) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = PullFeedSubmitResponseMany {
        ...
        let args = PullFeedSubmitResponseManyInstructionArgs {
...
/// `pull_feed_submit_response_many` CPI accounts.
pub struct PullFeedSubmitResponseManyCpiAccounts<'a, 'b> {
...
/// `pull_feed_submit_response_many` CPI instruction.
pub struct PullFeedSubmitResponseManyCpi<'a, 'b> {
    ...
    pub __args: PullFeedSubmitResponseManyInstructionArgs,
}

impl<'a, 'b> PullFeedSubmitResponseManyCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: PullFeedSubmitResponseManyCpiAccounts<'a, 'b>,
        args: PullFeedSubmitResponseManyInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `PullFeedSubmitResponseMany` via CPI.
///
/// ### Accounts:
///
///   0. `[]` queue
...
///   7. `[]` token_mint
#[derive(Clone, Debug)]
pub struct PullFeedSubmitResponseManyCpiBuilder<'a, 'b> {
    instruction: Box<PullFeedSubmitResponseManyCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> PullFeedSubmitResponseManyCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(PullFeedSubmitResponseManyCpiBuilderInstruction {
            __program: program,
            queue: None,
            program_state: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = PullFeedSubmitResponseManyCpi {
...
#[derive(Clone, Debug)]
struct PullFeedSubmitResponseManyCpiBuilderInstruction<'a, 'b> {
