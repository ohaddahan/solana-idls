...
impl QueueAddMrEnclave {
    pub fn instruction(
        &self,
        args: QueueAddMrEnclaveInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&QueueAddMrEnclaveInstructionData::new()).unwrap();
...
pub struct QueueAddMrEnclaveInstructionData {
    discriminator: [u8; 8],
}

impl QueueAddMrEnclaveInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for QueueAddMrEnclaveInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct QueueAddMrEnclaveInstructionArgs {
    pub mr_enclave: [u8; 32],
}

/// Instruction builder for `QueueAddMrEnclave`.
///
/// ### Accounts:
///
///   0. `[writable]` queue
...
pub struct QueueAddMrEnclaveBuilder {
...
impl QueueAddMrEnclaveBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = QueueAddMrEnclave {
        ...
        let args = QueueAddMrEnclaveInstructionArgs {
...
/// `queue_add_mr_enclave` CPI accounts.
pub struct QueueAddMrEnclaveCpiAccounts<'a, 'b> {
...
/// `queue_add_mr_enclave` CPI instruction.
pub struct QueueAddMrEnclaveCpi<'a, 'b> {
    ...
    pub __args: QueueAddMrEnclaveInstructionArgs,
}

impl<'a, 'b> QueueAddMrEnclaveCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: QueueAddMrEnclaveCpiAccounts<'a, 'b>,
        args: QueueAddMrEnclaveInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `QueueAddMrEnclave` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` queue
...
///   3. `[]` state
#[derive(Clone, Debug)]
pub struct QueueAddMrEnclaveCpiBuilder<'a, 'b> {
    instruction: Box<QueueAddMrEnclaveCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> QueueAddMrEnclaveCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(QueueAddMrEnclaveCpiBuilderInstruction {
            __program: program,
            queue: None,
            authority: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = QueueAddMrEnclaveCpi {
...
#[derive(Clone, Debug)]
struct QueueAddMrEnclaveCpiBuilderInstruction<'a, 'b> {
